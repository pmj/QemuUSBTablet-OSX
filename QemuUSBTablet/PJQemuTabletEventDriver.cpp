...
#include "PJQemuTabletEventDriver.h"
...
OSDefineMetaClassAndStructors(PJQemuUSBTableEventDriver, IOHIDEventService);
...
//===========================================================================
// PJQemuUSBTableEventDriver class

#define super IOHIDEventService


//====================================================================================================
// PJQemuUSBTableEventDriver::init
//====================================================================================================
bool PJQemuUSBTableEventDriver::init( OSDictionary * dictionary )
{
...
//====================================================================================================
// PJQemuUSBTableEventDriver::free
//====================================================================================================
void PJQemuUSBTableEventDriver::free ()
{
    if ( _reportHandlers )
    {
        OSArray * temp;
...
//====================================================================================================
// PJQemuUSBTableEventDriver::handleStart
//====================================================================================================
bool PJQemuUSBTableEventDriver::handleStart( IOService * provider )
{
    ...
    if (number) 
		...
		IOLog("Boot protocol: detected %u, setting to 0\n", bootProtocol);
		bootProtocol = 0;
...
//====================================================================================================
// PJQemuUSBTableEventDriver::getTransport
//====================================================================================================
OSString * PJQemuUSBTableEventDriver::getTransport ()
{
    return _interface->getTransport();
}

//====================================================================================================
// PJQemuUSBTableEventDriver::getManufacturer
//====================================================================================================
OSString * PJQemuUSBTableEventDriver::getManufacturer ()
{
    return _interface->getManufacturer();
}

//====================================================================================================
// PJQemuUSBTableEventDriver::getProduct
//====================================================================================================
OSString * PJQemuUSBTableEventDriver::getProduct ()
{
    return _interface->getProduct();
}

//====================================================================================================
// PJQemuUSBTableEventDriver::getSerialNumber
//====================================================================================================
OSString * PJQemuUSBTableEventDriver::getSerialNumber ()
{
    return _interface->getSerialNumber();
}

//====================================================================================================
// PJQemuUSBTableEventDriver::getLocationID
//====================================================================================================
UInt32 PJQemuUSBTableEventDriver::getLocationID ()
{
    return _interface->getLocationID();
}

//====================================================================================================
// PJQemuUSBTableEventDriver::getVendorID
//====================================================================================================
UInt32 PJQemuUSBTableEventDriver::getVendorID ()
{
    return _interface->getVendorID();
}

//====================================================================================================
// PJQemuUSBTableEventDriver::getVendorIDSource
//====================================================================================================
UInt32 PJQemuUSBTableEventDriver::getVendorIDSource ()
{
    return _interface->getVendorIDSource();
}

//====================================================================================================
// PJQemuUSBTableEventDriver::getProductID
//====================================================================================================
UInt32 PJQemuUSBTableEventDriver::getProductID ()
{
    return _interface->getProductID();
}

//====================================================================================================
// PJQemuUSBTableEventDriver::getVersion
//====================================================================================================
UInt32 PJQemuUSBTableEventDriver::getVersion ()
{
    return _interface->getVersion();
}

//====================================================================================================
// PJQemuUSBTableEventDriver::getCountryCode
//====================================================================================================
UInt32 PJQemuUSBTableEventDriver::getCountryCode ()
{
...
//====================================================================================================
// PJQemuUSBTableEventDriver::handleStop
//====================================================================================================
void PJQemuUSBTableEventDriver::handleStop(  IOService * provider __unused )
{
    //_interface->close(this);
}

//=============================================================================================
// PJQemuUSBTableEventDriver::didTerminate
//=============================================================================================
bool PJQemuUSBTableEventDriver::didTerminate( IOService * provider, IOOptionBits options, bool * defer )
{
    _interface->close(this);
...
//====================================================================================================
// PJQemuUSBTableEventDriver::findElements
//====================================================================================================
bool PJQemuUSBTableEventDriver::findElements ( OSArray* elementArray, UInt32 bootProtocol)
{
    UInt32              count       = 0;
    UInt32              index       = 0;
    UInt32              usage       = 0;
                ...
                switch ( usage )
                {
                    ...
                    case kHIDUsage_GD_X:
                        _bootSupport &= ~kMouseXAxis;
												...
												IOLog("kHIDUsage_GD_X flags: %08x\n", element->getFlags());
                    ...
                    case kHIDUsage_GD_Y:
												IOLog("kHIDUsage_GD_Y flags: %08x\n", element->getFlags());
...
//====================================================================================================
// PJQemuUSBTableEventDriver::storeReportElement
//====================================================================================================
bool PJQemuUSBTableEventDriver::storeReportElement ( IOHIDElement * element )
{
    OSArray **  array;
    SInt32      type;
...
//====================================================================================================
// PJQemuUSBTableEventDriver::getReportElements
//====================================================================================================
OSArray * PJQemuUSBTableEventDriver::getReportElements()
{
    return _supportedElements;
}

//====================================================================================================
// PJQemuUSBTableEventDriver::_handleInterruptReport
//====================================================================================================
void PJQemuUSBTableEventDriver::_handleInterruptReport (
                                OSObject *                  target,
...
{
    PJQemuUSBTableEventDriver *  self = (PJQemuUSBTableEventDriver *)target;
    
    self->handleInterruptReport(timeStamp, report, reportType, reportID);
}

//====================================================================================================
// PJQemuUSBTableEventDriver::setButtonState
//====================================================================================================
...
//====================================================================================================
// PJQemuUSBTableEventDriver::handleInterruptReport
//====================================================================================================
void PJQemuUSBTableEventDriver::handleInterruptReport (
                                AbsoluteTime                timeStamp,
                                IOMemoryDescriptor *        report,
                                IOHIDReportType             reportType,
                                UInt32                      reportID)
...
//====================================================================================================
// PJQemuUSBTableEventDriver::handleBootPointingReport
//====================================================================================================
void PJQemuUSBTableEventDriver::handleBootPointingReport (
                                IOMemoryDescriptor *        report,
                                SInt32 *                    dX,
                                SInt32 *                    dY,
                                UInt32 *                    buttonState)
...
//====================================================================================================
// PJQemuUSBTableEventDriver::setElementValue
//====================================================================================================
void PJQemuUSBTableEventDriver::setElementValue (
                                UInt32                      usagePage,
                                UInt32                      usage,
                                UInt32                      value )
{
...
//====================================================================================================
// PJQemuUSBTableEventDriver::getElementValue
//====================================================================================================
UInt32 PJQemuUSBTableEventDriver::getElementValue ( 
                                UInt32                      usagePage,
                                UInt32                      usage )
{
	IOHIDElement *element = 0;
